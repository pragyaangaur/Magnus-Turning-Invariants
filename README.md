# The Impossible Rendezvous

### Exact turning laws for a ball with vertical-axis spin, and why air resistance forbids the head-on collision
...
$$\frac{dw}{ds} = \bigl(i k_L - k_D\bigr)\,w \qquad\Longrightarrow\qquad \boxed{\;w(s) = w_0\,e^{-(k_D - i k_L)\,s}\;}$$
